...
def main_(query: str):
    if query:
        ...
        page_source: str = get(f"https://music.youtube.com/search?q={query}", headers=headers).content.decode("unicode_escape")
        ...
        if id:
            ...
            meta = get(f"https://www.youtube.com/oembed?url=https://www.youtube.com/watch?v={id}", headers=headers).json()
